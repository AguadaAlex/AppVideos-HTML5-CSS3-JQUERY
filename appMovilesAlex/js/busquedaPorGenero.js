...
$(document).ready(function(){
    geneId = getParameterByName('geneId');
     // OBTENER PARAMETRO 
    ...
    $.get(url,function(datos){
        console.log(datos.results);
          ...
          if(totalResultados<=10){
            $(".paginacion").html(`
            <ul class="muje">
            <li><a href="porGenero.html?geneId=${geneId}&Id=1" class="active">${pag}</a></li>
          </ul>
            `);
        }
        else
            ...
            if(pag<totalPaginas){
                if(pag>1){
                    if(pag+2>totalPaginas){
                        $(".paginacion").html(`
                        <ul class="muje">
                        <li><a href="porGenero.html?geneId=${geneId}&Id=${pag-1}">Prev</a></li>
                        <li><a href="porGenero.html?geneId=${geneId}&Id=${pag}" class="active">${pag}</a></li>
                        <li><a href="porGenero.html?geneId=${geneId}&Id=${pag+1}">${pag + 1}</a></li>
                    ...
                    <li><a href="porGenero.html?geneId=${geneId}&Id=${pag}" class="active">${pag}</a></li>
                    <li><a href="porGenero.html?geneId=${geneId}&Id=${pag+1}">${pag + 1}</a></li>
                    <li><a href="porGenero.html?geneId=${geneId}&Id=${pag+2}">${pag + 2}</a></li>
                    <li><a href="porGenero.html?geneId=${geneId}&Id=${pag+1}">next</a></li>
                </ul>
                `);
                }
                else{
